...
if __name__ == "__main__":
    while True:
        ...
        # If text is recognized, translate and analyze
        if recognized_text:
            original_text, translated_text = translate_text(recognized_text, target_language="en")
            print(f"Original Text: {original_text}")
            print(f"Translated Text: {translated_text}")

            analyze_and_click(translated_text, driver)
